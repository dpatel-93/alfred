...
$action = New-ScheduledTaskAction -Execute $nodePath -Argument 'server.mjs' -WorkingDirectory $brainDir
...
try {
    Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger `
        ...
        -Description 'ALFRED server - starts hidden at logon, restarts on failure.' `
...
Write-Host "  Working: $brainDir" -ForegroundColor Green
