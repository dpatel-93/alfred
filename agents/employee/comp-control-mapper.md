...
skills: org-index, vault-recall, verification-before-completion
---
...
| `/azure-audit` (command, not a preloaded skill) | Reading the actual Azure resource or Terraform state accurately enough to know what configuration I'm mapping, not just what it's named. |
