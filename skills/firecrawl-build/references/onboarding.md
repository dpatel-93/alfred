...
| Task | Reference |
|---|---|
| **Run the browser auth flow and save `FIRECRAWL_API_KEY`** | [references/auth-flow.md](auth-flow.md) |
| **Install the right SDK** | [references/sdk-installation.md](sdk-installation.md) |
| **Put credentials into `.env` or project config** | [references/project-setup.md](project-setup.md) |
...
| **Start implementation from a known URL** | [scrape](scrape.md) |
| **Start implementation from a query** | [search](search.md) |
