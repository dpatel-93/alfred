...
Adapted from [RinDig/icm-architect](https://github.com/RinDig/icm-architect) (721★, MIT) on
2026-08-14. Upstream is unmodified except for this section — pull their changes, don't fork the method.

## Where this applies in Alfred, and where it does NOT
...
classification taxonomy produces a cheaper delegation *shape* on cross-domain work. A second
finding in the same run: the residual cost is the verification discipline, and that "is not
overhead; it is the product."

So the ICM instinct "the entry file should be tiny" is **already falsified for this framework's own
charter layer**. Applying it there would repeat an experiment that has been run. Use ICM for
organising *content and work*, which is what it was measured on — not for trimming instructions,
which it was not.

If a future change makes someone want to shrink the charter again, re-read `brain/R3-FINAL-REPORT.md`
and `brain/ablation-minimal-charter.md` first.
