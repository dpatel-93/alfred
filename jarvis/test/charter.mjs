...
// vp-cto is a real chartered agent on this machine; __ghost-agent deliberately
// is not; the subagent node is a live transcript, which must keep its old path.
const CHARTERED = 'roster:vp-cto';
const GHOST = 'roster:__ghost-agent';
const LIVE = 'subagent:live-one';

const payload = {
  generatedAt: new Date().toISOString(),
  tiers: { ceo: { name: 'Dishi' } },
  agents: [
    { id: CHARTERED, label: 'vp-cto', tier: 'vp', model: 'opus', status: 'idle', parent: null },
