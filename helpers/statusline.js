#!/usr/bin/env node
/**
 * Alfred V3.5 Statusline Generator
...
function getSystemMetrics() {
  ...
  try {
    const agents = execSync('ps aux 2>/dev/null | grep -c "alfred-flow.*agent" || echo "0"', { encoding: 'utf-8' });
...
function generateStatusline() {
  ...
  // Header Line
  let header = `${c.bold}${c.brightPurple}▊ Alfred V3.5 ${c.reset}`;
