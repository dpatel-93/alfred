...
if ((command === 'issue' || command === 'pr') && 
  ...
  if (body) {
    ...
    try {
      ...
      // Execute safely using execFileSync to prevent shell injection
    ...
    // No body content, execute normally using execFileSync (no shell)
    execFileSync('gh', args, { stdio: 'inherit' });
  }
} else {
  // Other commands, execute normally using execFileSync (no shell)
  execFileSync('gh', args, { stdio: 'inherit' });
}
